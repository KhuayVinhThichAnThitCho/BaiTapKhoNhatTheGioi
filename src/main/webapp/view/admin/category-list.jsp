                    ...
                    <td>
                        <c:choose>
                            ...
                            <c:when test="${role eq 'admin'}">
                                <a href="${pageContext.request.contextPath}/admin/category/edit?id=${c.categoryId}">✏️ Sửa</a>
                                |
                            ...
                            <c:when test="${role eq 'manager' && c.user.categoryId == sessionScope.user.categoryId}">
                                <a href="${pageContext.request.contextPath}/manager/category/edit?id=${c.categoryId}">✏️ Sửa</a>
                                |
